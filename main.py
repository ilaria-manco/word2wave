...
if __name__ == "__main__":
    ...
    parser.add_argument("--pretrained_models_path", type=str, default="/homes/im311/repos/coalagan/wavegan/gan_fs_loop.tar", help="path to store wavegan and coala pretrained models")
